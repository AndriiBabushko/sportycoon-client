...
export const TrainingNav: FC<Props> = ({ currentRoute }) => {
  return (
    <Container
      className={`h-[${TRAINING_NAV_HEIGHT}px] justify-center border-b border-gray-300 bg-[${COLORS.GRAY}] fixed top-0 left-0 w-full z-10 px-2`}
    >
      <Flex justify={"between"} align={"center"}>
        <Link href="/" className="flex items-center">
          <Icons.RaccoonLogo height={80} width={120} />
        </Link>
